...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    parser.add_argument('-diff', type=bool, const=True, default=pconfig['diff'])
    parser.add_argument('-log', type=bool, const=True, default=pconfig['log'])
    parser.add_argument('-cor', type=bool, const=True, default=pconfig['corotate'])
    parser.add_argument('-s', type=bool, const=True, default=pconfig['streamlines'])
    ...
    parser.add_argument('-isp', type=bool, const=True, default=pconfig['isPlanet'])
    parser.add_argument('-cart', type=bool, const=True, default=pconfig['cartesian'])
    parser.add_argument('-p', type=str, default=pconfig['profile'])
    parser.add_argument('-cmap', type=str, default=pconfig['cmap'])
    parser.add_argument('-full', type=bool, const=True, default=pconfig['fullfilm'])
    parser.add_argument('-pbar', type=bool, const=True, default=pconfig['progressBar'])
    parser.add_argument('-multi', type=bool, const=True, default=pconfig['parallel'])
